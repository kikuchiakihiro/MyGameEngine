...
//	   {XMVectorSet(1.0f, -1.0f, -1.0f, 0.0f),XMVectorSet(0.5f, 0.0f, 0.0f, 0.0f) },  // 上面（右上）5
//	   {XMVectorSet(1.0f, -1.0f,  1.0f, 0.0f),XMVectorSet(0.5f, 0.5f, 0.0f, 0.0f) },    // 上面（右下）6
//	   {XMVectorSet(-1.0f, -1.0f,  1.0f, 0.0f),XMVectorSet(0.25f, 0.5f, 0.0f, 0.0f) },  // 上面（左下）7
//	  
//	   //面３
...
//
//	   //面４
//	  {XMVectorSet(-1.0f, 1.0f, 1.0f, 0.0f),XMVectorSet(0.75f,  0.0f, 0.0f, 0.0f) },   // 測面左（左上）12
//	  {XMVectorSet(-1.0f,  1.0f, -1.0f, 0.0f),XMVectorSet(1.0f, 0.0f, 0.0f, 0.0f) },  // 測面左（右上）13
//	  {XMVectorSet(-1.0f, -1.0f, -1.0f, 0.0f),XMVectorSet(1.0f, 0.5f, 0.0f, 0.0f) },  // 測面左（右下）14
//	  {XMVectorSet(-1.0f, -1.0f, 1.0f, 0.0f),XMVectorSet(0.75f, 0.5f, 0.0f, 0.0f) },  // 測面左（左下）15
//
//	  //面５
...
//
//	   //面６
//	   {XMVectorSet(1.0f, 1.0f,   1.0f, 0.0f),XMVectorSet( 0.25f, 0.5f, 0.0f, 0.0f) },    // 背面（左上）20
//	   {XMVectorSet(-1.0f,  1.0f, 1.0f, 0.0f),XMVectorSet(0.5f, 0.5f, 0.0f, 0.0f)   },   // 背面（右上）21
//	   {XMVectorSet(-1.0f, -1.0f, 1.0f, 0.0f),XMVectorSet(0.5f, 1.0f, 0.0f, 0.0f)   },   // 背面（右下）22
//	   {XMVectorSet(1.0f, -1.0f,  1.0f, 0.0f),XMVectorSet( 0.25f, 1.0f, 0.0f, 0.0f) },   // 背面（左下）23
//
//	};
//
//	// 頂点データ用バッファの設定
